...
async def init():
    ...
    LOGGER("NEXIOMUSIC.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await NEXIO.start()
    try:
        await NEXIO.stream_call("https://te.legra.ph/file/29f784eb49d230ab62e9e.mp4")
